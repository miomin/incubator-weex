(this.nativeLog || function(s) {console.log(s)})('Start JS Framework 0.29.4, Build at 2019-03-05 16:04. (Vue: 2.5.16-weex.5, Rax: 0.4.20)');
...
var subversion = {"framework":"0.29.4","transformer":">=0.1.5 <0.5"};
...
TaskCenter.prototype.callComponent = function callComponent (ref, method, args, options) {
  if (typeof global.callNativeComponent === 'function') {
    nativeLog("[jsfm] callComponent -> callNativeComponent ");
    return global.callNativeComponent(this.instanceId, ref, method, args, options)
  }
   nativeLog("[jsfm] callComponent -> fallback :" + typeof global.callNativeComponent);
  return fallback(this.instanceId, [{ component: options.component, ref: ref, method: method, args: args }])
};
...
TaskCenter.prototype.callModule = function callModule (module, method, args, options) {
  ...
  if (typeof global.callNativeModule === 'function') {
   ...
   nativeLog("[jsfm] callModule -> id:"+this.instanceId +" | args:"+JSON.stringify(tmpArg));
...
function getJSFMVersion () {
  ...
  return "0.29.4" // eslint-disable-line
}
...
function register (weex, options) {
    ...
    if (options.exposeModuleGetter) {
        setGlobalAPI(MODULE_GETTER, createModuleGetter(function () { return runtime; }));
    }
    renderer.ready();
    return runtime;
}
...
function scopedModuleAdaptor(weex, windmill, moduleGetter) {
    ...
    var runtimeGetter = function () { return windmill; };
