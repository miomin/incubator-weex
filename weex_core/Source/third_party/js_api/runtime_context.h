...
class RuntimeContext {
 public:
  ...
  static std::unique_ptr<RuntimeContext> Create(RuntimeVM* vm);

  virtual ~RuntimeContext() {}
  virtual void CreateJavaScriptContext() = 0;
  ...
  virtual bool ExecuteJavaScript(const std::string& name) = 0;
  virtual std::unique_ptr<RuntimeValues> ExecuteJavaScriptWithResult(
