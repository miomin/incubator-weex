(this.nativeLog || function(s) {console.log(s)})('Start JS Framework 0.29.1, Build at 2018-12-19 16:07. (Vue: 2.5.16-weex.5, Rax: 0.4.20)');
...
var subversion = {"framework":"0.29.1","transformer":">=0.1.5 <0.5"};
...
function getJSFMVersion () {
  ...
  return "0.29.1" // eslint-disable-line
}
...
function createInstanceContext (id, options, data) {
  ...
  // for(var key in instanceContext){
  //   let item_value = instanceContext[key];
  //   let item_value_json = JSON.stringify(item_value);
  //    nativeLog("[jsfm][createInstanceContext] key:"+ key +" | valuetype:"+ typeof(item_value) +" value:"+ item_value_json);
  // }
...
function registerModules(modules, noWarning) {
    nativeLog("registerModules:"+JSON.stringify(modules) +"| noWarning :"+noWarning);
